...
Blockly.Blocks["tank_moveForward"] = {
  init: function () {
    this.setColour(208);
    this.appendDummyInput().appendField(Blockly.Msg.TANK_MOVE);
...
Blockly.Blocks["tank_fire"] = {
  init: function () {
    this.setColour(208);
    this.appendDummyInput().appendField(Blockly.Msg.TANK_FIRE);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
...
Blockly.Blocks["tank_stop"] = {
  init: function () {
    this.setColour(208);
    this.appendDummyInput().appendField(Blockly.Msg.TANK_STOP);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
