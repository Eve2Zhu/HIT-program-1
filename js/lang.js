...
Lang.initLanguage = function () {
  ...
  if (reg3.exec(pathname)) {
    ...
    document.getElementsByClassName("memname1")[0].textContent =
      ABMSG["memname1"];
    document.getElementsByClassName("memname2")[0].textContent =
      ABMSG["memname2"];
    document.getElementsByClassName("memname3")[0].textContent =
      ABMSG["memname3"];
    document.getElementsByClassName("memname4")[0].textContent =
      ABMSG["memname4"];
